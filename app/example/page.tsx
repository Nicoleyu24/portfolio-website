...
export default function Parent() {
    ...
    return (
        <div className="flex flex-col justify-center items-center h-screen border border-red-500">
            ...
            <ChildComponent
                inputNumber={20}
                inputFunction={changeVariable}
                children={<div className="flex flex-col items-center">
                    hello
                    <div className="bg-red-800/20 p-2 border border-red-500 border-2 rounded-full px-10 hover:bg-red-800/50 hover:hidden">asdasdasdasdsd</div>
                </div>}
            />
...
function ChildComponent(props: ChildComponentProps) {
    ...
    return (
        <div className="flex flex-col justify-center items-center h-[50vh] w-[50vw] border border-purple-500 border-4 p-10 pb-20">
            ...
            <button className="bg-green-900" onClick={() => setCount(count + 1)}>Press</button>
